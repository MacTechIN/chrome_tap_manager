...
- **커밋**: `455b5fb` (태그 `ext-v0.3.0`, #19~#24 일괄)
...
## #25 · 2026-09-13 · ext-v0.3.0 커밋·푸시
...
## #32 · 2026-09-15 · 커밋·푸시 ext-v1.0.0

- **요청**: "커밋 푸쉬"
- **수행**: E12 커밋 `b5008a9`, 태그 `ext-v1.0.0`(EM6). 개인키 `keys/*.pem`은 제외되고 공개키 `keys/pub.b64`만 포함됨을 확인. README·DEV_PLAN에 해시 반영 후 `main`과 태그 푸시
