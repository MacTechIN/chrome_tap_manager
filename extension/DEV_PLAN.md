...
|---|---|---|---|---|---|---|
| E00 | 저장소 골격 및 격리 구조 | ✅ 완료 | 2026-09-11 | 2026-09-11 | `420f0de` / `v0.2.0` | #05, #06 |
| E01 | WXT 스캐폴딩 | ✅ 완료 (Chrome 152 실기기 로드 확인 2026-09-12) | 2026-09-11 | 2026-09-11 | `420f0de` / `v0.2.0` | #07, #11 |
| E02 | 도메인 모델 + 저장소 | ✅ 완료 | 2026-09-11 | 2026-09-11 | `de8396b` / `ext-v0.1.0` | #10 |
| E03 | 창·탭 이벤트 수집기 | ✅ 완료 (실기기 팝업 확인. seq는 SW 유휴 재기동 시에만 연속, 확장 리로드 시 초기화 — 설계상 허용) | 2026-09-12 | 2026-09-12 | `de8396b` / `ext-v0.1.0` | #12, #13 |
| E04 | Topic = 창 모델 | ✅ 완료 (실기기 시나리오 확인은 사용자 검증 대기) | 2026-09-12 | 2026-09-12 | `9404ba5` / `ext-v0.2.0` | #14 |
| E05 | 검색 엔진 코어 + 커맨드 파서 | ✅ 완료 | 2026-09-12 | 2026-09-12 | `9404ba5` / `ext-v0.2.0` | #15 |
| E06 | Popup 검색창 + 정리 커맨드 + IME | ✅ 완료 (양 OS IME 수동 테스트는 사용자 검증 대기) | 2026-09-12 | 2026-09-12 | `9404ba5` / `ext-v0.2.0` | #16 |
| E07 | Omnibox | ✅ 완료 (주소창 실기기 확인은 사용자 검증 대기) | 2026-09-12 | 2026-09-12 | `455b5fb` / `ext-v0.3.0` | #19 |
| E08 | Side Panel 개요 + 하위 그룹 | ✅ 완료 (실기기 드래그·그룹 확인은 사용자 검증 대기) | 2026-09-12 | 2026-09-12 | `455b5fb` / `ext-v0.3.0` | #22 |
| E09 | 규칙: 행동 학습 제안 + 수동 규칙 | ✅ 완료 (실기기 제안 배너·자동 이동 확인은 사용자 검증 대기) | 2026-09-13 | 2026-09-13 | (미커밋) | #27 |
| E10 | Bridge 클라이언트 인터페이스 | ✅ 완료 (실제 호스트 연동은 `bridge/` 프로젝트 몫) | 2026-09-13 | 2026-09-13 | (미커밋) | #28 |
| E11 | 세션 복원 + Topic 열기/닫기 | ✅ 완료 — **범위 축소(v0.3)**: 지문 재연결(#18), `>close`(확인 단계), JSON 내보내기/가져오기, 데이터 초기화. `>open`/`>save`/저장 탭 폐지 | 2026-09-14 | 2026-09-14 | (미커밋) | #29 |
| E12 | 옵션 · 패키징 · 스토어 | ⬜ 대기 | | | | |
