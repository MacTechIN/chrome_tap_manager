...
//
//   <text>               search open windows/tabs
//   #<topic> <text>      search inside one topic
//   ><cmd> <arg>         command mode: move | new | rename | close | merge
//
...
export const COMMANDS = ['move', 'new', 'rename', 'close', 'merge'] as const;
export type CommandName = (typeof COMMANDS)[number];

export type ArgKind = 'topic' | 'name' | 'optionalTopic' | 'none';
...
export const COMMAND_INFO: Record<CommandName, CommandInfo> = {
  ...
  close: { arg: 'optionalTopic', description: '주제 창 닫기', usage: '>close [주제]' },
